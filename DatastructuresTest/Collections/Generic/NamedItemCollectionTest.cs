namespace RJCP.Core.Collections.Generic
{
    ...
    public class NamedItemCollectionTest
    {
        ...
        public void AddItem()
        {
            NamedItems items = new() { new NamedItem("one") };
        ...
        {
            NamedItem item = new("one");
            NamedItems items = new() { item };
        ...
        {
            NamedItem item1 = new("one");
            NamedItem item2 = new("two");
            NamedItem item3 = new("three");
            NamedItems items = new() { item1, item2, item3 };
